...
<br/>
<label style={{backgroundColor:'blue', color:"white", fontSize:'large'}} htmlFor="email">email Id:</label>
<input id='email' type="email" name='email' placeholder='Enter email' onChange={formik.handleChange} value={formik.values.email} />
<br/>
<label style={{backgroundColor:'blue', color:"white", fontSize:'large'}} htmlFor="pass">Password:</label>
